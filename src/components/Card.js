...
function Card(prop) {
    ...
    return (
        <>
            <div className="card mb-4 bg-dark  shadow-sm moviecard" style={{ "width": "200px", "height": "300px","border":"none"}}>
                <div>
                <img src={infoicon} alt="infoincon" className="rateBtn"/>
                <Link to={`/movieInfo/${prop.id}`}><button style={{"position":"absolute","width":"40px","height":"40px","border":"none","borderRadius":"5px","opacity":"0"}}></button>
